...
SAVE_MODEL = True
MODEL_PATH = "../models/answerrnn3_att.h5"
SHOW_PLOTS = False
...
if DATASET == Semeval2017:
    ...
    ATT_DIM = 100  # dim. of attentive output, should be a fraction of EMBEDDINGS_SIZE; best: 50
    BATCH_SIZE = 256
    ...
    ATT_DIM = 100  # dim. of attentive output; best: 50
    BATCH_SIZE = 512
...
if not SAVE_MODEL or not os.path.isfile(MODEL_PATH):
    ...
    context_document = layers.Bidirectional(
        layers.LSTM(int(EMBEDDINGS_SIZE/2),
                    ...
                    return_sequences=True))(embedded_document)
    '''
    ...
    context_candidate = layers.Bidirectional(
        layers.LSTM(int(EMBEDDINGS_SIZE/2),
                    activation='tanh',
                    recurrent_activation='tanh',
                    return_sequences=True))(embedded_candidate)
    '''
