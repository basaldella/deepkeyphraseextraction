import numpy as np
import random as rn
#import tensorflow as tf  # gl: to use ELMo pretrainde model
#import tensorflow_hub as hub  # gl: to use ELMo pretrainde model
...
#from keras import backend as K  # gl: to use ELMo pretrainde model
